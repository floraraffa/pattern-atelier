...
const STRINGS: { [lang: string]: { [key: string]: string } } = {
  es: {
    ...
    micHint: "El mic funciona en las Specs; acá escribí con el teclado ⌨",
  ...
  en: {
    ...
    micHint: "Mic works on Specs; type with the keyboard here ⌨",
    listening: "● Listening…",
  ...
  pt: {
    ...
    micHint: "O mic funciona nos Specs; aqui digite no teclado ⌨",
    listening: "● Ouvindo…",
  ...
  fr: {
    ...
    micHint: "Le micro marche sur les Specs ; ici, tape au clavier ⌨",
    listening: "● J'écoute…",
  ...
  it: {
    ...
    micHint: "Il mic funziona sugli Specs; qui scrivi con la tastiera ⌨",
    listening: "● Ascolto…",
  ...
  de: {
    ...
    micHint: "Das Mikro geht auf den Specs; hier per Tastatur tippen ⌨",
    listening: "● Ich höre…",
  ...
  ru: {
    ...
    micHint: "Микрофон работает на Specs; здесь набери с клавиатуры ⌨",
    listening: "● Слушаю…",
  ...
  zh: {
    ...
    voiceError: "语音错误",
    micHint: "麦克风在 Specs 上可用;这里请用键盘输入 ⌨",
    listening: "● 正在听…",
    working: "正在绘制纸样…",
  ...
  ja: {
    ...
    voiceError: "音声エラー",
    micHint: "マイクはSpecsで使えるよ。ここではキーボードで入力してね ⌨",
    listening: "● 聞いています…",
    working: "型紙を作成中…",
  ...
  ar: {
    ...
    voiceError: "خطأ صوتي",
    micHint: "الميكروفون يعمل على النظارة؛ هنا اكتب بلوحة المفاتيح ⌨",
    listening: "● أستمع…",
  ...
  fa: {
    ...
    voiceError: "خطای صدا",
    micHint: "میکروفون روی Specs کار می‌کنه؛ اینجا با کیبورد بنویس ⌨",
    listening: "● گوش می‌دم…",
